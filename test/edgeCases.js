...
describe('flamegraph edge cases', () => {
    ...
    describe('search with special characters and regex', () => {
        ...
        it('should handle no match search', () => {
            ...
            expect(detailsElem.textContent).toBe('search: 0 of 10 total samples ( 0.000%)')
        })
    ...
    describe('merge functionality', () => {
        ...
        it('should merge with existing children', () => {
            ...
            const stacks = {
                ...
                value: 10,
                children: [
                    { name: 'func1', value: 5, children: [{ name: 'func1.child', value: 2 }] }
                ]
            }
    ...
    describe('error handling and edge cases', () => {
        ...
        it('should handle custom label handler', () => {
            const chart = flamegraph().setLabelHandler((d) => 'custom: ' + d.data.name)
            const stacks = {
                name: 'root',
                value: 1,
                children: []
    ...
    describe('click and hover handlers', () => {
        it('should handle onClick', () => {
            ...
            const chart = flamegraph().onClick((d) => { clickedData = d })
            const stacks = {
                name: 'root',
                value: 1,
                children: []
        ...
        it('should handle onHover', () => {
            let hoverData = null
            const chart = flamegraph().onHover((d) => { hoverData = d })
            const stacks = {
                name: 'root',
                value: 1,
                children: []
